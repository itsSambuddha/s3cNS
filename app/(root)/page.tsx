...
// ALL heavy components loaded with ssr: false for lightning fast initial render
const CinematicHero = dynamic(
  () => import('@/components/landing/CinematicHero').then(mod => ({ default: mod.CinematicHero })),
  { ssr: false }
)
const ConstitutionPreview = dynamic(
  () => import('@/components/landing/constitution-preview').then(mod => mod.ConstitutionPreview),
  { ssr: false, loading: () => <ConstitutionPreviewSkeleton /> }
)
const SeniorSecretariatCarousel = dynamic(
  () => import('@/components/secretariat/SeniorSecretariatCarousel').then(mod => mod.SeniorSecretariatCarousel),
  { ssr: false, loading: () => <SeniorSecretariatCarouselSkeleton /> }
)
const SecmunFeatures = dynamic(
  () => import('@/components/landing/secmunFeatures').then(mod => mod.SecmunFeatures),
  { ssr: false, loading: () => <SecmunFeaturesSkeleton /> }
)
const SecmunGlobe = dynamic(
  () => import('@/components/landing/secmunGlobe').then(mod => mod.SecmunGlobe),
  { ssr: false, loading: () => <SecmunGlobeSkeleton /> }
)
const ParticipationSection = dynamic(
  () => import('@/components/public/ParticipationSection').then(mod => mod.ParticipationSection),
  { ssr: false }
)
...
export default function LandingPage() {
  ...
  return (
    <div className="w-full">
      ...
      {/* 2. REST OF THE PAGE */}
      <div className="space-y-16 pb-16 sm:space-y-24 sm:pb-24 pt-24 bg-white">
