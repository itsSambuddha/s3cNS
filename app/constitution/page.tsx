  ...
  return (
    <div className="flex min-h-screen bg-background">
      ...
      <div className="flex flex-1 flex-col">
        <Navbar />
        <main className="flex-1 px-3 pt-4 pb-0 sm:px-6 sm:pt-6 sm:pb-0">
          <div className="mx-auto w-full max-w-6xl relative px-4 pt-10 lg:px-6">
      {/* soft background gradient, similar to ConstitutionPreview */}
      <div className="pointer-events-none absolute inset-0 -z-10">
        ...
        <div className="absolute bottom-[-15%] left-[20%] h-52 w-52 rounded-full bg-indigo-200/25 blur-3xl" />
      </div>
