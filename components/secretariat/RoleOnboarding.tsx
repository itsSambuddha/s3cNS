...
export function RoleOnboarding({ initialName, initialEmail }: { initialName?: string | null; initialEmail?: string | null }) {
  console.log('RoleOnboarding mounted', { initialName, initialEmail })
